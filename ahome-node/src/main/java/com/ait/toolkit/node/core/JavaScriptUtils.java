...
public class JavaScriptUtils {
	...
	public static native JavaScriptObject getProperty(JavaScriptObject parent,
			String propertyName) /*-{
	...
	public static StringBuilder appendException(Throwable throwable,
	...
	private static StringBuilder appendException(Throwable throwable,
		...
		if (throwable instanceof JavaScriptException) {
			...
			builder.append("    JS Error: ")
					.append(Util.get().inspect(
							((JavaScriptException) throwable).getException(),
							true)).append('\n');
		}
