...
/**
 * The node.js <a href="http://nodejs.org/docs/v0.5.6/api/fs.html">fs</a> module.
 * 
 * 
 */
...
public class Fs extends JavaScriptObject implements NodeJsModule {
	...
	public final void link(String srcpath, String dstpath, JavaScriptFunctionWrapper callback) {
		link(srcpath, dstpath, callback.getNativeFunction());
	}

	public final void link(String srcpath, String dstpath, FsEventHandler callback) {
		link(srcpath, dstpath, callback.getNativeFunction());
	}

	public final native void link(String srcpath, String dstpath, JavaScriptFunction callback) /*-{
	...
	public final void symlink(String linkdata, String path, JavaScriptFunctionWrapper callback) {
		symlink(linkdata, path, callback.getNativeFunction());
	}

	public final void symlink(String linkdata, String path, FsEventHandler callback) {
		symlink(linkdata, path, callback.getNativeFunction());
	}

	public final native void symlink(String linkdata, String path, JavaScriptFunction callback) /*-{
	...
	public final void open(String path, String flags, int mode, JavaScriptFunctionWrapper callback) {
		open(path, flags, mode, callback.getNativeFunction());
	}

	public final void open(String path, String flags, int mode, FileDescriptorEventHandler callback) {
		open(path, flags, mode, callback.getNativeFunction());
	}

	public final native void open(String path, String flags, int mode, JavaScriptFunction callback) /*-{
	...
	public final void open(String path, String flags, JavaScriptFunctionWrapper callback) {
		open(path, flags, callback.getNativeFunction());
	}

	public final void open(String path, String flags, FileDescriptorEventHandler callback) {
		open(path, flags, callback.getNativeFunction());
	}

	public final native void open(String path, String flags, JavaScriptFunction callback) /*-{
	...
	public final native void write(int fd, Buffer buffer, int offset, int length, Integer position) /*-{
		this.write(fd, buffer, offset, length, position);
	}-*/;

	public final void write(int fd, Buffer buffer, int offset, int length, Integer position, JavaScriptFunctionWrapper callback) {
		write(fd, buffer, offset, length, position, callback.getNativeFunction());
	}

	public final void write(int fd, Buffer buffer, int offset, int length, Integer position, ByteCountEventHandler callback) {
		write(fd, buffer, offset, length, position, callback.getNativeFunction());
	}

	public final native void write(int fd, Buffer buffer, int offset, int length, Integer position, JavaScriptFunction callback) /*-{
		this.write(fd, buffer, offset, length, position, callback);
	}-*/;

	public final native int writeSync(int fd, Buffer buffer, int offset, int length, Integer position) /*-{
	...
	public final native int writeSync(int fd, String string, Integer position, String encoding) /*-{
		return this.writeSync(fd, string, position, encoding);
	}-*/;

	public final native void read(int fd, Buffer buffer, int offset, int length, Integer position) /*-{
		this.read(fd, buffer, offset, length, position);
	}-*/;

	public final void read(int fd, Buffer buffer, int offset, int length, Integer position, JavaScriptFunctionWrapper callback) {
		read(fd, buffer, offset, length, position, callback.getNativeFunction());
	}

	public final void read(int fd, Buffer buffer, int offset, int length, Integer position, ByteCountEventHandler callback) {
		read(fd, buffer, offset, length, position, callback.getNativeFunction());
	}

	public final native void read(int fd, Buffer buffer, int offset, int length, Integer position, JavaScriptFunction callback) /*-{
		this.read(fd, buffer, offset, length, position, callback);
	}-*/;

	public final native Buffer readSync(int fd, Buffer buffer, int offset, int length, Integer position) /*-{
		return this.readSync(fd, buffer, offset, length, position);
	}-*/;

	public final native String readSync(int fd, int length, Integer position, String encoding) /*-{
	...
	public final void readFile(String filename, String encoding, JavaScriptFunctionWrapper callback) {
		readFile(filename, encoding, callback.getNativeFunction());
	}

	public final void readFile(String filename, String encoding, StringEventHandler callback) {
		readFile(filename, encoding, callback.getNativeFunction());
	}

	public final native void readFile(String filename, String encoding, JavaScriptFunction callback) /*-{
	...
	public final void readFile(String filename, JavaScriptFunctionWrapper callback) {
		readFile(filename, callback.getNativeFunction());
	}

	public final void readFile(String filename, BufferEventHandler callback) {
		readFile(filename, callback.getNativeFunction());
	}

	public final native void readFile(String filename, JavaScriptFunction callback) /*-{
	...
	public final void writeFile(String filename, String data, String encoding, JavaScriptFunctionWrapper callback) {
		writeFile(filename, data, encoding, callback.getNativeFunction());
	}

	public final void writeFile(String filename, String data, String encoding, FsEventHandler callback) {
		writeFile(filename, data, encoding, callback.getNativeFunction());
	}

	public final native void writeFile(String filename, String data, String encoding, JavaScriptFunction callback) /*-{
		this.writeFile(filename, data, encoding, callback);
	}-*/;

	public final native void writeFileSync(String filename, String data, String encoding) /*-{
		this.writeFile(filename, data, encoding);
	}-*/;
	...
	public final void writeFile(String filename, String data, JavaScriptFunctionWrapper callback) {
		writeFile(filename, data, callback.getNativeFunction());
	}

	public final void writeFile(String filename, String data, FsEventHandler callback) {
		writeFile(filename, data, callback.getNativeFunction());
	}

	public final native void writeFile(String filename, String data, JavaScriptFunction callback) /*-{
	...
	public final void writeFile(String filename, Buffer data, String encoding, JavaScriptFunctionWrapper callback) {
		writeFile(filename, data, encoding, callback.getNativeFunction());
	}

	public final void writeFile(String filename, Buffer data, String encoding, FsEventHandler callback) {
		writeFile(filename, data, encoding, callback.getNativeFunction());
	}

	public final native void writeFile(String filename, Buffer data, String encoding, JavaScriptFunction callback) /*-{
		this.writeFile(filename, data, encoding, callback);
	}-*/;

	public final native void writeFileSync(String filename, Buffer data, String encoding) /*-{
		this.writeFile(filename, data, encoding);
	}-*/;
	...
	public final void writeFile(String filename, Buffer data, JavaScriptFunctionWrapper callback) {
		writeFile(filename, data, callback.getNativeFunction());
	}

	public final void writeFile(String filename, Buffer data, FsEventHandler callback) {
		writeFile(filename, data, callback.getNativeFunction());
	}

	public final native void writeFile(String filename, Buffer data, JavaScriptFunction callback) /*-{
		this.writeFile(filename, data, callback);
	}-*/;
	...
	public final void watchFile(String filename, WatchFileOptions options, JavaScriptFunctionWrapper callback) {
		watchFile(filename, options, callback.getNativeFunction());
	}

	public final void watchFile(String filename, WatchFileOptions options, WatchFileEventHandler callback) {
		watchFile(filename, options, callback.getNativeFunction());
	}

	public final native void watchFile(String filename, WatchFileOptions options, JavaScriptFunction callback) /*-{
